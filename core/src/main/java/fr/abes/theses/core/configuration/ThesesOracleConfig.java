package fr.abes.theses.core.configuration;
...
public class ThesesOracleConfig {
    ...
    public LocalContainerEntityManagerFactoryBean thesesEntityManagerFactory() {
        ...
        em.setPackagesToScan("fr.abes.theses.batch.entities");
    ...
    @Bean
    public JpaTransactionManager thesesTransactionManage(EntityManagerFactory em) {
