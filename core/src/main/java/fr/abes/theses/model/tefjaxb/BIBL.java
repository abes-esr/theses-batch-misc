 ...
 *       &lt;attribute name="indicTheseTravaux" use="required" type="{http://www.w3.org/2001/XMLSchema}NCName" /&gt;
    ...
    extends TefNotes
{
    ...
    @XmlAttribute(name = "indicTheseTravaux", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "NCName")
    protected String indicTheseTravaux;
    ...
    /**
     * Obtient la valeur de la propriété indicTheseTravaux.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getIndicTheseTravaux() {
        return indicTheseTravaux;
    }

    /**
     * Définit la valeur de la propriété indicTheseTravaux.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setIndicTheseTravaux(String value) {
        this.indicTheseTravaux = value;
    }
